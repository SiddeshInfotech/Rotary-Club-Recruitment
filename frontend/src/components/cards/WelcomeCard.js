...
export default function WelcomeCard() {
    return (
        <div className="group bg-white rounded-2xl shadow-sm border border-gray-100 p-8 relative overflow-hidden h-full flex flex-col justify-between hover:shadow-xl hover:border-blue-100 transition-all duration-500">
            ...
            <div className="absolute top-0 right-0 w-80 h-80 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 group-hover:opacity-60 
                            group-hover:scale-110 transition-all duration-700 -translate-y-1/2 translate-x-1/3"></div>
            ...
            <div className="mt-8 bg-[#f8fafc] rounded-xl p-5 border border-gray-100 relative z-10 
                            group-hover:bg-white group-hover:shadow-[0_4px_20px_rgb(0,0,0,0.03)] transition-all duration-300">
                ...
                <div className="flex gap-3">
                    <button className="px-5 py-2 flex items-center gap-2 bg-white border border-gray-200 rounded-lg 
                                        text-xs font-semibold text-gray-700 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 hover:-translate-y-0.5 transition-all shadow-sm">
                        <FileText className="w-3.5 h-3.5" /> Upload Resume
                    </button>

                    <button className="px-5 py-2 flex items-center gap-2 bg-white border border-gray-200 rounded-lg 
                                        text-xs font-semibold text-gray-700 hover:bg-gray-50 hover:-translate-y-0.5 transition-all shadow-sm">
