    ...
    return (
        <div className="bg-white dark:bg-[#131b2f] border border-slate-200 dark:border-[#1e293b] rounded-2xl p-10 flex flex-col justify-between shadow-sm dark:shadow-none hover:shadow-md transition">
            <div className="mb-10">
                ...
                <h2 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white mb-4 font-serif">Leadership</h2>
            ...
            <div>
                <div className="flex justify-between items-end mb-4">
                    ...
                    <span className="text-lg font-bold text-blue-600 dark:text-blue-400">94<span className="text-sm text-slate-400 dark:text-slate-500 font-medium">/100</span></span>
                </div>
                <div className="w-full h-2.5 bg-slate-200 dark:bg-slate-800 rounded-full mb-10 overflow-hidden">
                    <div className="w-[94%] h-full bg-blue-600 dark:bg-blue-500 rounded-full shadow-sm"></div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div className="bg-slate-50 dark:bg-[#0b1121] border border-slate-100 dark:border-[#1e293b] p-6 rounded-2xl shadow-sm hover:shadow transition">
                        ...
                        <p className="text-3xl font-black text-slate-900 dark:text-white">98th</p>
                    </div>
                    <div className="bg-slate-50 dark:bg-[#0b1121] border border-slate-100 dark:border-[#1e293b] p-6 rounded-2xl shadow-sm hover:shadow transition">
                        <p className="text-xs font-bold tracking-widest uppercase text-slate-400 dark:text-slate-500 mb-2">TRAIT STABILITY</p>
                        <p className="text-3xl font-black text-slate-900 dark:text-white">High</p>
                    </div>
                </div>
            </div>
        </div>
