...
export default function RecruiterLayout({ children }) {
    ...
    return (
        <div className="flex h-screen overflow-hidden font-sans bg-slate-50 dark:bg-[#0b1121]">
            <aside className="w-[300px] h-full bg-white dark:bg-transparent border-r border-slate-200 dark:border-slate-800 flex flex-col py-8 px-6 relative z-10 flex-shrink-0 hidden lg:flex">
