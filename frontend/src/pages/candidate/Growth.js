    ...
    return (
        <CandidateLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                <div className="bg-white dark:bg-[#131b2f] border border-slate-200 dark:border-[#1e293b] p-8 rounded-2xl shadow-sm text-center">
            ...
            <div className="bg-white dark:bg-[#131b2f] border border-slate-200 dark:border-[#1e293b] rounded-2xl shadow-sm p-8">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex gap-4 p-6 border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-[#0b1121] rounded-xl hover:shadow-md transition">
