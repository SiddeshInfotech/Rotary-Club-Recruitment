            ...
            <div className="max-w-6xl mx-auto space-y-8 pb-10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Manage and schedule candidate interviews.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        {interviews.map(interview => (
                            <div key={interview.id} className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 p-5 flex flex-col sm:flex-row gap-5 items-start sm:items-center hover:shadow-md transition-shadow">
                                ...
                                <div className="flex-grow min-w-0">
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-2">
                                        <div>
                                            <h3 className="font-bold text-[#1a2b4b] dark:text-white text-lg leading-tight">{interview.candidate}</h3>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4 pt-4 border-t border-gray-50 dark:border-slate-800">
                                        ...
                                        <div className="flex items-center gap-2 text-sm font-medium text-gray-800 dark:text-slate-300">
                                            {interview.round}
                                        </div>
                                    </div>
                                </div>
                                <div className="flex sm:flex-col gap-2 w-full sm:w-auto mt-4 sm:mt-0">
                                    <button className="flex-1 sm:w-full bg-cyan-50 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 hover:bg-cyan-100 dark:hover:bg-cyan-500/20 px-4 py-2 rounded-lg font-semibold text-sm transition-colors text-center border border-transparent">
                                        Join Call
                                    </button>
                                    <button className="flex-1 sm:w-full bg-white dark:bg-slate-800 text-gray-600 dark:text-slate-300 border border-gray-200 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700 px-4 py-2 rounded-lg font-semibold text-sm transition-colors text-center">
                                        Reschedule
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-gray-500 dark:text-slate-400">To be scheduled</span>
                                        <span className="font-bold text-gray-900 dark:text-white">7</span>
                                    </div>
                                    <div className="w-full h-2 bg-gray-100 dark:bg-slate-800 rounded-full"><div className="w-[35%] h-full bg-amber-500 rounded-full"></div></div>
                                </div>
                            </div>
                        </div>
